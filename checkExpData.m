...
for n = 1 : length(fileNames)
    ...
    disp(strcat(num2str(length(unique(Data.stimONTimes))),...
        " unique stim ON times (",num2str(Data.stimONTimes(1)),'-',...
        num2str(Data.stimONTimes(end)),')'));
    disp(strcat(num2str(length(unique(Data.stimOnFrameNum))),...
        " unique stim frame numbers (",num2str(Data.stimOnFrameNum(1)),...
        '-',num2str(Data.stimOnFrameNum(end)),')'));
    disp('---------------------------------------------------------------');
end